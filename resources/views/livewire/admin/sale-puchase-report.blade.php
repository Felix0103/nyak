<div>
    ...
    <div wire:loading wire:target="search" class="row justify-content-center items-align-center">
        <p class="display-4"><span class="badge badge-success">Generating Report...</span></p>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        @if ($report_info != null && $report_info->count() >0 && $driver_id > 0 )
